        ...
        <div>
            ...
            <div>
                <form class="profile-area-form" action="" method="POST">
                    ...
                    <textarea id="house-description" class="input-form" name="description" required="required" row="3"
                              placeholder="Banana house is super cool!"></textarea>
