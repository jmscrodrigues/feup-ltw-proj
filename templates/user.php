    ...
    <div>
      ...
      <div>
        <form class="profile-area-form" action="../actions/action_edit_username.php" method="POST">
          <input class="input-form" type="text" name="username" required="required" placeholder="<?= $result['username'] ?>">
          <input class="input-form" type="text" name="name" required="required" placeholder="<?= $result['name'] ?>">
        ...
        <form class="profile-area-form" action="../actions/action_edit_contacts.php" method="POST">
          <input class="input-form" type="email" name="email" required="required" placeholder="<?= $result['email'] ?>">
